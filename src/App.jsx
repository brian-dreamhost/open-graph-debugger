    ...
    <div className="bg-abyss bg-glow bg-grid min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-12 animate-fadeIn">
        ...
        <nav className="mb-8 text-sm text-galactic">
          ...
          <a href="https://seo-tools-tau.vercel.app/social-media/" className="text-azure hover:text-white transition-colors">
            Social Media Tools
          </a>
          <span className="mx-2 text-metal">/</span>
          <span className="text-cloudy">Open Graph Debugger</span>
        </nav>

        {/* Header */}
        <header className="mb-10">
          <div className="flex items-start gap-4 mb-4">
            <div className="p-3 rounded-xl bg-azure/10 border border-azure/20">
